...
{0, 0, ITEM_MOON_STONE, ITEM_CHERI_BERRY, ITEM_BLACK_BELT, 1},
{0, 0, ITEM_MOON_STONE, ITEM_CHESTO_BERRY, ITEM_BLACK_GLASSES, 1},
{0, 0, ITEM_FIRE_STONE, ITEM_PECHA_BERRY, ITEM_CHARCOAL, 1},
{0, 0, ITEM_SUN_STONE, ITEM_RAWST_BERRY, ITEM_CHOICE_BAND, 1},
{0, 0, ITEM_FIRE_STONE, ITEM_ASPEAR_BERRY, ITEM_DRAGON_FANG, 1},
{0, 0, ITEM_SUN_STONE, ITEM_CHERI_BERRY, ITEM_FOCUS_BAND, 1},
{0, 0, ITEM_LEAF_STONE, ITEM_CHESTO_BERRY, ITEM_HARD_STONE, 1},
{0, 0, ITEM_LEAF_STONE, ITEM_PECHA_BERRY, ITEM_KINGS_ROCK, 1},
{0, 0, ITEM_LEAF_STONE, ITEM_RAWST_BERRY, ITEM_LEFTOVERS, 1},
{0, 0, ITEM_THUNDER_STONE, ITEM_PECHA_BERRY, ITEM_MAGNET, 1},
{0, 0, ITEM_THUNDER_STONE, ITEM_LEPPA_BERRY, ITEM_METAL_COAT, 1},
{0, 0, ITEM_LEAF_STONE, ITEM_ORAN_BERRY, ITEM_MIRACLE_SEED, 1},
{0, 0, ITEM_WATER_STONE, ITEM_PERSIM_BERRY, ITEM_MYSTIC_WATER, 1},
{0, 0, ITEM_WATER_STONE, ITEM_SITRUS_BERRY, ITEM_NEVER_MELT_ICE, 1},
{0, 0, ITEM_MOON_STONE, ITEM_RAZZ_BERRY, ITEM_POISON_BARB, 1},
{0, 0, ITEM_FIRE_STONE, ITEM_BLUK_BERRY, ITEM_QUICK_CLAW, 1},
{0, 0, ITEM_THUNDER_STONE, ITEM_NANAB_BERRY, ITEM_SCOPE_LENS, 1},
{0, 0, ITEM_LEAF_STONE, ITEM_WEPEAR_BERRY, ITEM_SHARP_BEAK, 1},
{0, 0, ITEM_WATER_STONE, ITEM_PINAP_BERRY, ITEM_SHELL_BELL, 1},
{0, 0, ITEM_SUN_STONE, ITEM_POMEG_BERRY, ITEM_SILK_SCARF, 1},
{0, 0, ITEM_MOON_STONE, ITEM_KELPSY_BERRY, ITEM_SILVER_POWDER, 1},
{0, 0, ITEM_SUN_STONE, ITEM_QUALOT_BERRY, ITEM_SOFT_SAND, 1},
{0, 0, ITEM_MOON_STONE, ITEM_HONDEW_BERRY, ITEM_SPELL_TAG, 1},
{0, 0, ITEM_FIRE_STONE, ITEM_GREPA_BERRY, ITEM_TWISTED_SPOON, 1},
{0, ITEM_POKE_BALL, ITEM_SUN_STONE, ITEM_CHERI_BERRY, ITEM_ULTRA_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_MOON_STONE, ITEM_CHESTO_BERRY, ITEM_GREAT_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_LEAF_STONE, ITEM_PECHA_BERRY, ITEM_NET_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_WATER_STONE, ITEM_RAWST_BERRY, ITEM_DIVE_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_LEAF_STONE, ITEM_ASPEAR_BERRY, ITEM_NEST_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_SUN_STONE, ITEM_LEPPA_BERRY, ITEM_REPEAT_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_THUNDER_STONE, ITEM_ORAN_BERRY, ITEM_TIMER_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_FIRE_STONE, ITEM_PERSIM_BERRY, ITEM_LUXURY_BALL, 10},
{0, ITEM_POKE_BALL, ITEM_MOON_STONE, ITEM_SITRUS_BERRY, ITEM_PREMIER_BALL, 10},
{ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_CHERI_BERRY, ITEM_SITRUS_BERRY, ITEM_BRIGHT_POWDER, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_PECHA_BERRY, ITEM_HONDEW_BERRY, ITEM_WHITE_HERB, 1},
{ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_CHERI_BERRY, ITEM_CHESTO_BERRY, ITEM_MACHO_BRACE, 1},
{ITEM_SUN_STONE, ITEM_FIRE_STONE, ITEM_CHESTO_BERRY, ITEM_PECHA_BERRY, ITEM_SOOTHE_BELL, 1},
{ITEM_SUN_STONE, ITEM_THUNDER_STONE, ITEM_PECHA_BERRY, ITEM_RAWST_BERRY, ITEM_MENTAL_HERB, 1},
{ITEM_SUN_STONE, ITEM_WATER_STONE, ITEM_RAWST_BERRY, ITEM_ASPEAR_BERRY, ITEM_AMULET_COIN, 1},
{ITEM_SUN_STONE, ITEM_LEAF_STONE, ITEM_ASPEAR_BERRY, ITEM_LEPPA_BERRY, ITEM_CLEANSE_TAG, 1},
{ITEM_MOON_STONE, ITEM_FIRE_STONE, ITEM_LEPPA_BERRY, ITEM_ORAN_BERRY, ITEM_SOUL_DEW, 1},
{ITEM_MOON_STONE, ITEM_THUNDER_STONE, ITEM_ORAN_BERRY, ITEM_PERSIM_BERRY, ITEM_DEEP_SEA_TOOTH, 1},
{ITEM_MOON_STONE, ITEM_WATER_STONE, ITEM_PECHA_BERRY, ITEM_PERSIM_BERRY, ITEM_DEEP_SEA_SCALE, 1},
{ITEM_MOON_STONE, ITEM_LEAF_STONE, ITEM_PECHA_BERRY, ITEM_SITRUS_BERRY, ITEM_SMOKE_BALL, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_SITRUS_BERRY, ITEM_RAZZ_BERRY, ITEM_LUCKY_EGG, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_RAZZ_BERRY, ITEM_BLUK_BERRY, ITEM_DRAGON_SCALE, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_BLUK_BERRY, ITEM_NANAB_BERRY, ITEM_LIGHT_BALL, 1},
{ITEM_THUNDER_STONE, ITEM_WATER_STONE, ITEM_NANAB_BERRY, ITEM_WEPEAR_BERRY, ITEM_UP_GRADE, 1},
{ITEM_THUNDER_STONE, ITEM_LEAF_STONE, ITEM_WEPEAR_BERRY, ITEM_PINAP_BERRY, ITEM_SEA_INCENSE, 1},
{ITEM_WATER_STONE, ITEM_LEAF_STONE, ITEM_PINAP_BERRY, ITEM_POMEG_BERRY, ITEM_LAX_INCENSE, 1},
{ITEM_SUN_STONE, ITEM_MOON_STONE, ITEM_POMEG_BERRY, ITEM_KELPSY_BERRY, ITEM_LUCKY_PUNCH, 1},
{ITEM_MOON_STONE, ITEM_FIRE_STONE, ITEM_KELPSY_BERRY, ITEM_QUALOT_BERRY, ITEM_METAL_POWDER, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_QUALOT_BERRY, ITEM_HONDEW_BERRY, ITEM_THICK_CLUB, 1},
{ITEM_THUNDER_STONE, ITEM_WATER_STONE, ITEM_HONDEW_BERRY, ITEM_GREPA_BERRY, ITEM_STICK, 1},
{ITEM_WATER_STONE, ITEM_LEAF_STONE, ITEM_CHERI_BERRY, ITEM_GREPA_BERRY, ITEM_EVERSTONE, 1}
};
