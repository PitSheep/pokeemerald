...
{ITEM_LEAF_STONE, ITEM_MOON_STONE, ITEM_PECHA_BERRY, ITEM_SITRUS_BERRY, ITEM_BRIGHT_POWDER, 1},
...
{ITEM_MOON_STONE, ITEM_SUN_STONE, ITEM_LUM_BERRY, ITEM_PECHA_BERRY, ITEM_DRAGON_SCALE, 1},
{ITEM_FIRE_STONE, ITEM_LEAF_STONE, ITEM_GREPA_BERRY, ITEM_PERSIM_BERRY, ITEM_FOCUS_BAND, 1},
{ITEM_MOON_STONE, ITEM_THUNDER_STONE, ITEM_ASPEAR_BERRY, ITEM_LEPPA_BERRY, ITEM_KINGS_ROCK, 1},
{ITEM_FIRE_STONE, ITEM_WATER_STONE, ITEM_GREPA_BERRY, ITEM_ORAN_BERRY, ITEM_LAX_INCENSE, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_LEPPA_BERRY, ITEM_PERSIM_BERRY, ITEM_LIGHT_BALL, 1},
{ITEM_LEAF_STONE, ITEM_SUN_STONE, ITEM_CHESTO_BERRY, ITEM_LUM_BERRY, ITEM_LUCKY_EGG, 1},
{ITEM_FIRE_STONE, ITEM_MOON_STONE, ITEM_LEPPA_BERRY, ITEM_SITRUS_BERRY, ITEM_LUCKY_PUNCH, 1},
{ITEM_LEAF_STONE, ITEM_THUNDER_STONE, ITEM_ASPEAR_BERRY, ITEM_ORAN_BERRY, ITEM_MACHO_BRACE, 1},
{ITEM_MOON_STONE, ITEM_SUN_STONE, ITEM_LEPPA_BERRY, ITEM_PERSIM_BERRY, ITEM_MENTAL_HERB, 1},
{ITEM_FIRE_STONE, ITEM_MOON_STONE, ITEM_LUM_BERRY, ITEM_PECHA_BERRY, ITEM_METAL_POWDER, 1},
{ITEM_LEAF_STONE, ITEM_WATER_STONE, ITEM_GREPA_BERRY, ITEM_SITRUS_BERRY, ITEM_SEA_INCENSE, 1},
{ITEM_FIRE_STONE, ITEM_THUNDER_STONE, ITEM_ASPEAR_BERRY, ITEM_LEPPA_BERRY, ITEM_SHELL_BELL, 1},
{ITEM_LEAF_STONE, ITEM_SUN_STONE, ITEM_CHESTO_BERRY, ITEM_PECHA_BERRY, ITEM_SMOKE_BALL, 1},
{ITEM_MOON_STONE, ITEM_WATER_STONE, ITEM_GREPA_BERRY, ITEM_ORAN_BERRY, ITEM_SOOTHE_BELL, 1},
{ITEM_FIRE_STONE, ITEM_SUN_STONE, ITEM_LEPPA_BERRY, ITEM_PERSIM_BERRY, ITEM_SOUL_DEW, 1},
{ITEM_LEAF_STONE, ITEM_THUNDER_STONE, ITEM_GREPA_BERRY, ITEM_LUM_BERRY, ITEM_STICK, 1},
{ITEM_FIRE_STONE, ITEM_MOON_STONE, ITEM_ASPEAR_BERRY, ITEM_PECHA_BERRY, ITEM_THICK_CLUB, 1},
{ITEM_MOON_STONE, ITEM_WATER_STONE, ITEM_LEPPA_BERRY, ITEM_PERSIM_BERRY, ITEM_UP_GRADE, 1},
{ITEM_FIRE_STONE, ITEM_SUN_STONE, ITEM_CHESTO_BERRY, ITEM_ORAN_BERRY, ITEM_WHITE_HERB, 1}
};
