const struct Evolution gEvolutionTable[NUM_SPECIES][EVOS_PER_MON] =
{
    ...
    [SPECIES_ONIX]       = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_STEELIX}},
    ...
    [SPECIES_SEADRA]     = {{EVO_ITEM, ITEM_MOON_STONE, SPECIES_KINGDRA}},
    [SPECIES_GOLDEEN]    = {{EVO_LEVEL, 33, SPECIES_SEAKING}},
    [SPECIES_STARYU]     = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_STARMIE}},
    [SPECIES_SCYTHER]    = {{EVO_ITEM, ITEM_THUNDER_STONE, SPECIES_SCIZOR}},
    ...
    [SPECIES_PORYGON]    = {{EVO_ITEM, ITEM_FIRE_STONE, SPECIES_PORYGON2}},
    ...
    [SPECIES_CLAMPERL]   = {{EVO_ITEM, ITEM_WATER_STONE, SPECIES_HUNTAIL},
                            {EVO_ITEM, ITEM_LEAF_STONE, SPECIES_GOREBYSS}},
